...
const SHEET_DATA_SOURCE_URL = GOOGLE_SHEET_WOODY + GOOGLE_API_KEY
...
module.exports = async function (moduleOptions) {
  this.nuxt.hook('generate:before', async () => {
    ...
    drive.files.list({pageSize: 1000}, (err, res) => {
      ...
      const distGeneratePath = resolve(this.options.rootDir, join(this.options.alias.static, '/woodyData.json'))
      try {
